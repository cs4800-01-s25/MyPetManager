...
const adminNavItems = [
    ...
    { label: "Pet Profile", href: "/admin/pets", icon: <PawPrint size={20} /> },
    { label: "Health Portal", href: "/admin/health-records", icon: <FileArchive size={20} /> },
    { label: "Schedule", href: "/admin/appointments", icon: <Calendar size={20} /> },
];
...
export const AdminLayout = ({ children, currentPath = "/admin" }: AdminLayoutProps) => {
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      {/* Sidebar */}
      <aside 
        className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-[#7c5c42] text-white transition-all duration-300 ease-in-out hidden md:block`}
      >
      ...
      {/* Mobile Sidebar */}
      <div className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} fixed inset-0 z-50 md:hidden transition-transform duration-300 ease-in-out`}>
        <div className="absolute inset-0 bg-gray-600 opacity-75" onClick={toggleSidebar}></div>
        <aside className="relative w-64 h-full bg-[#7c5c42] text-white">
          <div className="p-4 flex items-center justify-between border-b border-[#6a4f38]">
          ...
          <div className="absolute bottom-0 w-full p-4 border-t border-[#6a4f38]">
            <Link
              to="/"
              className="flex items-center py-2 px-4 rounded-lg hover:bg-[#6a4f38] transition-colors"
            >
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span className="ml-2 mr-1 hidden md:block">Admin User</span>
