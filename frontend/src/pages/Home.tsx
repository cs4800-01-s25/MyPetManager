...
const valuesData = [
  {
    title: "Convenience", // renamed from "Simplicity"
  ...
  },
  {
    ...
    description:
      "We prioritize the privacy of our users and are committed to ensuring that your pet's data is safe with us.",
  },
  {
    title: "Community",
...
export const Home = () => {
  return (
    <>
      ...
      <section className="w-full max-w-[1440px] bg-[#e8e1d9] relative px-4 pt-28 pb-[220px] overflow-hidden">
        ...
        <div className="flex justify-around items-center relative z-10">
          ...
          <div className="w-64 h-64 bg-white rounded-full flex flex-col justify-center items-center text-center border border-black shadow-md">
            <h2 className="text-[20px] font-['Poltawski_Nowy',Helvetica] font-bold mb-3">
              Health Portal
            </h2>
            <p className="px-4 text-sm">
              Keep track of medication and refill reminders
            </p>
          </div>

          {/* Circle 2 */}
          <div className="w-64 h-64 bg-white rounded-full flex flex-col justify-center items-center text-center border border-black shadow-md">
            <h3 className="text-[20px] font-['Poltawski_Nowy',Helvetica] font-bold mb-3">
              Scheduler
            </h3>
            <p className="px-4 text-sm">
              Include option of booking appointments for pet service
            </p>
          </div>
          ...
          <div className="w-64 h-64 bg-white rounded-full flex flex-col justify-center items-center text-center border border-black shadow-md">
            ...
            <p className="px-4 text-sm">
              Add a local forum page for local discussions
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-10">
          <div className="max-w-[520px] md:w-1/2">
            ...
            <p className="opacity-70 font-['Poppins',Helvetica] text-[#222222] text-[18px] leading-[28px] max-w-[400px]">
              My Pet Manager is more than just a website – it’s your all-in-one
              solution for keeping your pet’s health, appointments, and daily
              needs organized. From tracking vaccinations and vet visits to
              setting reminders for feeding and grooming, we ensure that
              managing your pet’s care is effortless. Because every pet deserves
              the best care, and every owner deserves peace of mind.
            </p>
          </div>
      ...
      {/* Our Values Section (from stashed changes, using valuesData) */}
      <section className="w-full max-w-[1440px] py-[120px] px-[100px] bg-[#e8e1d9]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[26px]">
          {/* Render first three values in separate cards */}
